...
path = r'C:\JC\tfrecord\model\Inception.ckpt'
trainpath = [r'C:\JC\tfrecord\64_shuffle\train.tfrecords',
             r'C:\JC\tfrecord\64_shuffle\train_001.tfrecords']
testpath = [r'C:\JC\tfrecord\64_shuffle\test.tfrecords',
            r'C:\JC\tfrecord\64_shuffle\test_001.tfrecords']
validpath = [r'C:\JC\tfrecord\64_shuffle\validation.tfrecords']
