...
class trainwork(object):
    def __init__(self):
        with tf.variable_scope('scop'):
            self.weights={
                ...
                'conv3':tf.get_variable('w3', [5,5,40,20],initializer=tf.contrib.layers.xavier_initializer_conv2d()),
                'fc1':tf.get_variable('w4', [8*8*20,1024],initializer=tf.contrib.layers.xavier_initializer_conv2d()),
                'out':tf.get_variable('w5', [1024,classnum],initializer=tf.contrib.layers.xavier_initializer_conv2d())
            }
            self.biases={
                ...
                'conv3': tf.get_variable('b3', [20],initializer=tf.constant_initializer(0.0)),
                'fc1': tf.get_variable('b4', [1024],initializer=tf.constant_initializer(0.0)),
                'out': tf.get_variable('b5', [classnum],initializer=tf.constant_initializer(0.0))
            }
    ...
    def inference(self,images):
        ...
        flat=tf.reshape(pool3,[-1,8*8*20])
